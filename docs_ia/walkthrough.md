...
6. **Métrica de Saldo Restante (Real-Time):** Adicionamos um novo indicador vital no cabeçalho do Dashboard. Ao lado da "Mana Total", o sistema passa a calcular e exibir em tempo real o "Saldo Restante". Ele cruza a sua Renda do Mês contra todas as suas Despesas Pessoais. Se você gastar menos que o salário, ele brilha em Esmeralda. Se estourar a Renda, ele assume a cor de Alerta Vermelho.
